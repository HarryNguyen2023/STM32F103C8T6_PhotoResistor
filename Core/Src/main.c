...
#define ADC_RES 4096 // 12-bit ADC module have the maximum value of 4096
...
uint16_t photores = 0;
uint16_t pwm_val = 0;
static uint16_t Vamb = 0; 		// Variable of the initial ambient light intensity
uint8_t first = 0;
char msg[25];
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
	...
	{
		// Feed the value to the PWM module to change the intensity of the LED
